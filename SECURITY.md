...
[Security → Report a vulnerability](https://github.com/smeet666/mcp-ptitchef/security/advisories/new).
...
A read-only client for Ptitchef. It needs no API key and no account, it
