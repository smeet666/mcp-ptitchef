...
import { PtitchefError, invalidInput, notFound } from "../../src/errors.js";
...
describe("toToolError", () => {
  ...
  it("turns a value that is not a PtitchefError into a network_error keeping its message", () => {
  ...
  it("keeps a PtitchefError apart from an ordinary Error", () => {
    expect(notFound("x")).toBeInstanceOf(PtitchefError);
    expect(new Error("x")).not.toBeInstanceOf(PtitchefError);
  });
});
